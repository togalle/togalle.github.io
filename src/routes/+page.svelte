...
<div class="home-wrapper">
	...
	<div class="flex">
		...
		<section class="half">
			<h2>Contact info</h2>
			<a href={'https://www.linkedin.com/in/tomas-galle-6b4baa164'} class="button"
				><svg
			...
			>
			<a href={`https://t.me/taykuuu`} target="_blank" class="button"
				><svg
					xmlns="http://www.w3.org/2000/svg"
					width="16"
					height="16"
